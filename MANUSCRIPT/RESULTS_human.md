...
In a previous study, we established that chronic administration of palmitoylethanolamide (PEA) exerts robust neuroprotective effects in 12-month-old male Tg2576 mice (Tortolani et al., 2025). In this study, we investigated whether this efficacy could be extended to females, given the well-documented sexual dimorphism in both Alzheimer's disease (AD) and endocannabinoid metabolism (add some relevant references). First of all, we evaluated whether chronic treatment with PEA (30 mg/kg/day for 6 months) improved cognitive performance in 12-month-old female Tg2576 mice, assessed by recognition memory using the new object recognition test (NORT).
